...
namespace AnimalShelter\Admin\Taxonomy;
...
class Taxonomy {
	...
	public function get_taxonomies_status_labels(): array {
		return array(
			...
			'new_item_name'              => __( 'New status name', 'animal-shelter' ),
	...
	public function get_taxonomies_size_labels(): array {
		return array(
			...
			'new_item_name'              => __( 'New size name', 'animal-shelter' ),
	...
	public function get_taxonomies_color_labels(): array {
		return array(
			...
			'new_item_name'              => __( 'New color name', 'animal-shelter' ),
  ...
  public function get_taxonomies_energy_labels(): array {
		return array(
			...
			'new_item_name'              => __( 'New energy name', 'animal-shelter' ),
