...
class ANIMALSHELTER_TAXONOMY_DOG_BREED_Cat extends Animalshelter_Taxonomy {
	public function __construct() {
		parent::__construct();
		$this->taxonomy         = ANIMALSHELTER_TAXONOMY_CAT_BREED;
		$this->taxonomy_rewrite = 'cat-breed';
	}
